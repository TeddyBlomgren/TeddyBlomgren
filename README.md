...
## 🧾 Om mig  
Jag är snart färdigutbildad systemutvecklare med fokus på fullstack-utveckling i Angular och .NET.
Just nu gör jag LIA på Consid där jag vidareutvecklar en intern hälsoportal med Angular och C#/.NET i ett befintligt projekt.  
Jag har även skapat egna projekt som *PetRegistry* och *Snackis Forum*, där jag kombinerat frontend, backend och databaser för att bygga kompletta lösningar.

---

## ⚙️ Vad jag gör  
- 💻 Bygger API-lösningar med **C#**, **.NET**, **Entity Framework** och **SQL Server**  
- 🧩 Utvecklar **fullstack-applikationer** med **Angular** och **TypeScript**  
- 🎨 Skapar **responsiva gränssnitt** med **Bootstrap** och **Blazor**  
- ☁️ Arbetar med **Azure** och **Azure DevOps** för hosting och CI/CD  
